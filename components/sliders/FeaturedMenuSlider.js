...
const FeaturedMenuSlider = ({ title, restuarantID }) => {
  ...
  const {
    ...
    menuCategoryName: "featured_menu",
  });
  // console.log("hello featured menu option", isMenuCategory);

  return (
    <VStack px={4}>
      <SectionTitle title={title} path="" />
