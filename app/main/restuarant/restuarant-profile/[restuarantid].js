...
import { RestuarantReviewSlider } from "../../../../components/sliders";
import { Platform } from "react-native";

const RestuarantProfilePage = () => {
      ...
      >
        <VStack mb={5}>
          ...
          >
            ...
            <VStack w="100%" py={3}>
              <Center mt={2} justifyContent="space-between" flexDirection="row">
                <HStack w="70%">
                  <IconButton
                    bg="white.500"
                    _icon={{
              ...
              <Center my={4} justifyContent="space-between" flexDirection="row">
                <HStack w="70%">
                  <IconButton
                    bg="white.500"
                    _icon={{
...
export default RestuarantProfilePage;
